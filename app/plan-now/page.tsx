              ...
              <div className="max-w-2xl">
                ...
                <RevealBlock delay={440}>
                  <div className="flex flex-wrap items-center gap-5">
                    <Link href="/quiero-afiliarme" className="px-7 py-3.5 rounded-full gradient-brand text-white font-bold text-sm hover:opacity-90 transition shadow-lg shadow-[#a73a8d]/30">
                      Quiero el plan NOW
                    </Link>
