...
export default function RecomendaTuPrestadorPage() {
  return (
    <main className="flex-1">

      {/* 1 · Intro */}
      <div className="sm:sticky sm:top-0 z-10">
        <section className="bg-white px-4 sm:px-6 lg:px-8 pt-14 pb-10" aria-labelledby="recomenda-heading">
          <div className="max-w-7xl mx-auto">
            ...
            <h1
              id="recomenda-heading"
              className="text-4xl sm:text-5xl font-black text-[#2D2A68] leading-[1.05] tracking-tight mb-3 text-balance"
            >
              <SlideUp delay={40}>Ampliamos la red</SlideUp>
              <SlideUp delay={140}>juntos.</SlideUp>
            </h1>
            <RevealBlock delay={180}>
              <p className="text-[#5A5A66] text-lg leading-relaxed max-w-xl">
                Si conocés a un profesional que debería estar en nuestra cartilla, ayudanos a encontrarlo. Cada recomendación suma.
              </p>
            </RevealBlock>
      ...
      <div className="sm:sticky sm:top-0 z-20 rounded-t-[2.5rem] overflow-hidden sm:min-h-screen bg-[#2D2A68] relative">
          ...
          <ProviderForm variant="recomendacion" />
      </div>
